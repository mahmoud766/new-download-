...
export async function getGlobalSettingsAction(): Promise<SiteSettings> {
  try {
    ...
    return {
      ...
      adsenseClientId: record.adsenseClientId || 'ca-pub-6708942894533593',
      ga4Id: record.ga4Id || 'G-2NBYGQ5V6E',
  ...
  try {
    ...
    const updated = await prisma.globalSettings.upsert({
      ...
      update: {
        ...
        adsenseClientId: input.adsenseClientId ?? 'ca-pub-6708942894533593',
        ga4Id: input.ga4Id ?? 'G-2NBYGQ5V6E',
    ...
    const formattedSettings: SiteSettings = {
      ...
      adsenseClientId: updated.adsenseClientId || 'ca-pub-6708942894533593',
      ga4Id: updated.ga4Id || 'G-2NBYGQ5V6E',
